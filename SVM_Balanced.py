...
data = pd.read_csv('results_corr_065_sem_modulo_mensal_sempolo_com_qtde_links_ajustado_sem_ruido.csv')
...
for train_index, test_index in kf.split(X):
    ...
    clf = SVC(kernel='linear',gamma='scale').fit(X_train,y_train.ravel())
